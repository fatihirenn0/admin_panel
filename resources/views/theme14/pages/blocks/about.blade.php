        ...
        <div class="row g-0">
            <div class="col-lg-4">
                <div class="about__item about__content">
                    <h4 class="color-light wow splt-txt" data-splitting>{{ __('Güvenilir Hukuki Uzmanlık, Her Davada Titizlikle Yaklaşım') }}</h4>
                    <ul>
                        <li>
                            ...
                            {{ __('Afet Sigortası ve Tazminat Davaları') }}
                        </li>
                        <li>
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M8 0.5C7.66563 7.39062 7.39062 7.66563 0.5 8C7.39062 8.33437 7.66563 8.60938 8 15.5C8.33437 8.60938 8.60938 8.33437 15.5 8C8.60938 7.66563 8.33437 7.39062 8 0.5Z" fill="white" />
                            </svg>
                            {{ __('Rüşvet ve Yolsuzluk Suçları') }}
                        </li>
                        <li>
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M8 0.5C7.66563 7.39062 7.39062 7.66563 0.5 8C7.39062 8.33437 7.66563 8.60938 8 15.5C8.33437 8.60938 8.60938 8.33437 15.5 8C8.60938 7.66563 8.33437 7.39062 8 0.5Z" fill="white" />
                            </svg>
                            {{ __('Döviz Mevzuatı ve Kripto Hukuku') }}
                        </li>
                        <li>
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M8 0.5C7.66563 7.39062 7.39062 7.66563 0.5 8C7.39062 8.33437 7.66563 8.60938 8 15.5C8.33437 8.60938 8.60938 8.33437 15.5 8C8.60938 7.66563 8.33437 7.39062 8 0.5Z" fill="white" />
                            </svg>
                            {{ __('Yapay Zeka Destekli Siber Suçlar') }}
                        </li>
                    </ul>
                    <a href="{{ route(getOtherFullLink('contact')) }}" class="btn-discover mt-50" data-splitting data-text="{{ __('Bize Ulaşın') }}">{{ __('Bize Ulaşın') }}</a>
                </div>
            </div>
            <div class="col-lg-4">
            ...
            <div class="col-lg-4">
                <div class="about__item about__funfact">
                    <h4 class="color-light wow splt-txt mb-40" data-splitting>{{ __('Dünyanın dört bir yanından 200 binden fazla müvekkil, hukuki süreçlerinde bize güvendi.') }}</h4>
                    <div>
                        <ul>
                            <li class="icon">
