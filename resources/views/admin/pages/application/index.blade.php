        ...
        <div class="card">
            <div class="card-datatable text-nowrap">
                <table class="datatables-ajax table table-bordered">
                    ...
                    <tr>
                        <th>{{ __('ID') }}</th>
                        <th>{{ __('Başvuru Adı') }}</th>
                        <th>{{ __('Meslek') }}</th>
                        <th>{{ __('E-Posta') }}</th>
                        <th>{{ __('Tecrübe') }}</th>
                        <th>{{ __('Telefon') }}</th>
                        <th>{{ __('Cinsiyet') }}</th>
                        <th>{{ __('Bölüm Departmanı') }}</th>
                        <th>{{ __('Tarih') }}</th>
                        <th>{{ __('İşlemler') }}</th>
                    </tr>
                    </thead>
...
@push('js')
    ...
    <script>
        let dt_ajax = new DataTable(document.querySelector('.datatables-ajax'), {
            ...
            serverSide: true,
            ajax: {
                url: '{{ route('admin.ajax.applications') }}',
            ...
            columns: [
                ...
                { data: 'experience', orderable: true, searchable: true },
                ...
                { data: 'birthdate', orderable: true, searchable: true },
