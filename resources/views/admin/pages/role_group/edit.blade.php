...
@section('title',__('Yetki Grubu Düzenle'))
@push('css')

@endpush
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <form id="mainForm" method="post" action="{{ route('admin.role-groups.update',$roleGroup) }}" enctype="multipart/form-data">
            @csrf @method('put')
            <div class="row g-6">
                                                ...
                                                <div class="d-flex justify-content-end">
                                                    <div class="form-check mb-0 me-4 me-lg-12">
                                                        <input class="form-check-input"
                                                               ...
                                                               name="role[]"
                                                               value="{{ $key }}_list"
                                                               {{ in_array($key.'_list',$roles) ? 'checked' : '' }}
                                                        />
                                                    ...
                                                    <div class="form-check mb-0 me-4 me-lg-12">
                                                        <input class="form-check-input"
                                                               ...
                                                               name="role[]"
                                                               value="{{ $key }}_add"
                                                               {{ in_array($key.'_add',$roles) ? 'checked' : '' }}
                                                        />
                                                    ...
                                                    <div class="form-check mb-0 me-4 me-lg-12">
                                                        <input class="form-check-input"
                                                               ...
                                                               name="role[]"
                                                               value="{{ $key }}_edit"
                                                                {{ in_array($key.'_edit',$roles) ? 'checked' : '' }}/>
                                                    ...
                                                    <div class="form-check mb-0">
                                                        <input class="form-check-input"
                                                               ...
                                                               name="role[]"
                                                               value="{{ $key }}_delete"
                                                                {{ in_array($key.'_delete',$roles) ? 'checked' : '' }}
                                                        />
