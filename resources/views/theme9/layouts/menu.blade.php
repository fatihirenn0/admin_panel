        ...
        <div class="row align-items-center">
            <div class="col-md-3">
                <div class="phone-call2 d-flex justify-content-start align-items-center flex-row gap-2">
                    <div class="icon">
                        <img src="/theme9/images/icons/call-icon2.svg" alt="{{ __('Menü Telefon İkon') }}" class="img-fluid mt-1 static-image" />
                    </div>
                    <div class="number">
                        <span>{{ __('Bize Ulaşın') }}</span>
                        <h5><a href="tel:{{ $settings->get('telephone') }}">{{ $settings->get('telephone') }}</a></h5>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
            ...
            <div class="col-md-3 d-flex justify-content-end">
                <div class="phone-call2 d-flex justify-content-start align-items-center flex-row gap-2">
                    <div class="icon">
                        <img src="/theme9/images/icons/envelope2.svg" alt="{{ __('Menü E-Posta İkon') }}" class="img-fluid mt-1 static-image" />
                    </div>
                    <div class="number">
...
<header class="header-area style-3">
    <div class="header-logo">
        <a href="{{ route('site.index') }}"><img alt="Logo" src="/storage/{{ $settings->get('logo_dark') }}" /></a>
    </div>
    <div class="main-nav">
        <div class="mobile-logo-area d-xl-none d-flex justify-content-between align-items-center">
            <div class="mobile-logo-wrap">
                <a href="{{ route('site.index') }}"><img alt="Logo" src="/storage/{{ $settings->get('logo_white') }}" /></a>
            </div>
        ...
        <ul class="menu-list">
            ...
            <li class="menu-item-has-children">
                <a href="#" class="drop-down">{{ __('Kurumsal') }}</a><i class="bi bi-chevron-down dropdown-icon"></i>
                <ul class="sub-menu">
            ...
            <li class="menu-item-has-children">
                <a href="{{ route(getResourceFullLink('services')) }}">{{ __('Hizmetler') }}</a><i class="bi bi-chevron-down dropdown-icon"></i>
                <ul class="sub-menu">
            ...
            <li class="menu-item-has-children">
                <a href="#" class="drop-down">{{ __('Bloglar') }}</a><i class="bi bi-chevron-down dropdown-icon"></i>
                <ul class="sub-menu">
        ...
        <div class="d-xl-none d-block">
            <div class="eg-btn btn--primary btn--lg d-xl-none d-flex">
                <a href="{{ route(getOtherFullLink('contact')) }}"><i class="bi bi-dash-lg"></i>{{ __('Bize Ulaşın') }}</a>
            </div>
        </div>
