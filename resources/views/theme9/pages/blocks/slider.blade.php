<!-- ========== banner1-area start============= -->
@if( \Illuminate\Support\Facades\Route::currentRouteName() == "site.index" ) @php $slider = $sliders->first(); @endphp @if($slider)
    <div class="banner-section">
        <div class="banner-social-area">
            <ul class="banner-social gap-4">
                @if($settings->get('twitter'))
                    <a href="{{ $settings->get('twitter') }}"><i class="bx bxl-twitter"></i></a>
                @endif @if($settings->get('facebook'))
                    <a href="{{ $settings->get('facebook') }}"><i class="bx bxl-facebook"></i></a>
                @endif @if($settings->get('linkedin'))
                    <a href="{{ $settings->get('linkedin') }}"><i class="bx bxl-linkedin"></i></a>
                @endif @if($settings->get('instagram'))
                    <a href="{{ $settings->get('instagram') }}"><i class="bx bxl-instagram"></i></a>
                @endif @if($settings->get('youtube'))
                    <a href="{{ $settings->get('youtube') }}"><i class="bx bxl-youtube"></i></a>
                @endif @if($settings->get('tiktok'))
                    <a href="{{ $settings->get('tiktok') }}"><i class="bx bxl-tiktok"></i></a>
                @endif @if($settings->get('google_business'))
                    <a href="{{ $settings->get('google_business') }}"><i class="bx bxl-google"></i></a>
                @endif
            </ul>
        </div>
        <div class="banner-scroll-area">
            <a href="#">{{ __('Kaydır') }}<i class="bi bi-arrow-right"></i></a>
        </div>
        <div class="container">
                ...
                <div class="col-lg-10">
                    <div class="banner-content">
                        ...
                        <div class="button-area">
                            <a href="{{ $slider->link }}l" class="eg-btn btn--primary btn--lg"><i class="bi bi-dash-lg"></i>{{ $slider->link_text }}</a>
