            ...
            <div class="col-lg-6 bg--light">
                <div class="contact-wrap wow fadeInLeft" data-wow-duration="1.5s" data-wow-delay="200ms">
                    <div class="section-title1 text-lg-start text-center">
                        <h2>{{ __('İletişim') }}</h2>
                        <p>{{ __('Danışmak istediğiniz her konuda bize ulaşabilirsiniz. Sorularınız, çözüme açılan kapıdır.') }}</p>
                    </div>
                    <form class="contact-form" action="{{ route('site.contact.message') }}" method="post">
                        @csrf @if ($errors->any())
                ...
                <ul class="address-list ps-lg-5">
                    ...
                    <li>
                        ...
                        <div class="text">
                            ...
                            <a href="tel:{{ $settings->get('address') }}">{{ $settings->get('address') }}</a>
                        </div>
                    </li>
                </ul>
                <div class="contact-image-area">
                    <img src="/theme9/images/bg/contact-img.png" alt="{{ __('Anasayfa İletişim Görseli') }}" class="contact-img wow fadeInUp static-image" data-wow-duration="1.5s" data-wow-delay="400ms" />
                </div>
            </div>
        </div>
    </div>
