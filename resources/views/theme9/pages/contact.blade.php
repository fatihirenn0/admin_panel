...
<div class="breadcrumb-section">
    <div class="container">
        <div class="row d-flex justify-content-center align-items-center text-center">
            <div class="col-lg-6">
                <h2 class="breadcrumb-title wow fadeInLeft" data-wow-duration="1.5s" data-wow-delay=".2s">{{ __('İletişim') }}</h2>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb d-flex justify-content-center">
                        <li class="breadcrumb-item"><a href="{{ route('site.index') }}">{{ __('Ana Sayfa') }}</a></li>
                        <li class="breadcrumb-item active" aria-current="page">{{ __('İletişim') }}</li>
                    </ol>
                </nav>
            </div>
        </div>
                    ...
                    <ul class="address-list sibling3">
                        ...
                        <li>
                            ...
                            <div class="text">
                                ...
                                <a href="mailto:{{ $settings->get('email') }}"><span class="__cf_email__" >{{ $settings->get('email') }}</span> </a> <br>
                            </div>
                        </li>
                    </ul>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-inner sibling2">
                                <input name="name" class="contact-form @error('name') is-invalid @enderror"
                        ...
                        <div class="col-lg-6">
                            <div class="form-inner sibling2">
                                <input name="email" class="contact-form @error('email') is-invalid @enderror"
                        ...
                        <div class="col-lg-6">
                            <div class="form-inner sibling2">
                                <input name="telephone" class="contact-form @error('telephone') is-invalid @enderror"
                        ...
                        <div class="col-lg-12">
                            <div class="form-inner sibling2">
                              <textarea name="message" class="contact-form @error('message') is-invalid @enderror"
