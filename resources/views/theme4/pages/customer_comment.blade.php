...
@section('content')
    <section class="page-header">
        ...
        <!-- /.page-header__shape -->
        <div class="container">
            <h2 class="page-header__title bw-split-in-right">{{ __('Müşteri Yorumları') }}</h2>
            <ul class="procounsel-breadcrumb list-unstyled">
                <li><a href="{{ route('site.index') }}">{{ __('Anasayfa') }}</a></li>
                <li><span>{{ __('Müşteri Yorumları') }}</span></li>
            </ul><!-- /.thm-breadcrumb list-unstyled -->
        </div><!-- /.container -->
    </section><!-- /.page-header -->
    <section class="testimonials-three" id="testimonial">
        <div class="testimonials-three__bg" style="background-image: url(/theme4/images/shapes/testimonial-bg-3.png);"></div>
        <div class="container">
            <div class="testimonials-three__top">
                <div class="sec-title text-left">
                    ...
                    <h3 class="sec-title__title bw-split-in-up"> {{ __('Müvekkillerimiz ') }} <br><span> {{ __('Ne Diyor?') }}</span></h3><!-- /.sec-title__title -->
                </div><!-- /.sec-title -->
                <div class="testimonials-three__info">
                    <div class="testimonials-three__info__rating">
                        <h3 class="testimonials-three__info__rating-value">{{ __('4.8/5') }}</h3>
                    ...
                    <div class="testimonials-three__info__content">
                        <h4 class="testimonials-three__info__title">{{ __('Müvekkil Memnuniyeti') }}</h4>
                        <p class="testimonials-three__info__text">{{ __('300+ doğrulanmış') }} <br> {{ __('değerlendirme') }}</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="container-fluid">
            <div class="testimonials-three__carousel procounsel-owl__carousel procounsel-owl__carousel--with-shadow procounsel-owl__carousel--basic-nav owl-carousel" data-owl-options='{
				"items": 1,
				"margin": 30,
				"loop": true,
				"smartSpeed": 700,
                ...
                <div class="item">
                    <div class="testimonials-card-three wow fadeInUp" data-wow-duration='1500ms'  data-wow-delay="{{ ($loop->index + 1) * 100 }}ms">
                        ...
                        <div class="testimonials-card-three__author">
                            ...
                            <div class="testimonials-card-three__author-info">
                                ...
                                <p class="testimonials-card-three__designation">{{ $customerComment->job }}</p>
                            </div>
