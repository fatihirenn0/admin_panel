...
@section('content')
    <section class="page-header">
        ...
        <!-- /.page-header__shape -->
        <div class="container">
            <h2 class="page-header__title bw-split-in-right">{{ __('İletişim') }}</h2>
            <ul class="procounsel-breadcrumb list-unstyled">
                <li><a href="{{ route('site.index') }}">{{ __('Ana Sayfa') }}</a></li>
                <li><span>{{ __('İletişim') }}</span></li>
            </ul><!-- /.thm-breadcrumb list-unstyled -->
        </div><!-- /.container -->
    </section><!-- /.page-header -->

    <section class="contact-one">
        <div class="contact-one__bg static-bg-image" style="background-image: url(/theme4/images/backgrounds/contact-1-bg.jpg);" alt="{{__('İletişim Sayfası Arka Plan Görseli')}}"></div>
                ...
                <div class="row">
                    <div class="col-xl-6">
                        <div class="sec-title text-left">
                            ...
                            <h3 class="sec-title__title bw-split-in-up"><span> {{ __('İletişim Formu') }}</span> </h3><!-- /.sec-title__title -->
                        </div><!-- /.sec-title -->
                        <div class="contact-one__content">
                            <div class="contact-one__content__bg bw-img-anim-left static-image" style="background-image: url(/theme4/images/resources/contact-1-1.jpg);" alt="{{ __('İletişim Sayfası İletişim Formu Arka Plan Görseli') }}"></div>
                            <ul class="list-unstyled contact-one__info">
                                <li class="contact-one__info__item">
                                    ...
                                    <div class="contact-one__info__content">
                                        <p class="contact-one__info__text">
                                            <a href="tel:{{ $settings->get('telephone') }}">{{ $settings->get('telephone') }}</a><br>
                                ...
                                <li class="contact-one__info__item">
                                    ...
                                    <div class="contact-one__info__content">
                                        <p class="contact-one__info__text">
                                            <a href="mailto:{{ $settings->get('email') }}">{{ $settings->get('email') }}</a><br>
                                        </p><!-- /.contact-one__info__text -->
                                    </div><!-- /.contact-one__info__content -->
                                </li>
                                <li class="contact-one__info__item">
                    ...
                    <div class="col-xl-6 wow fadeInUp" data-wow-delay="200ms">
                        <form class="contact-one__form contact-form-validated form-one" action="{{ route('site.contact.message') }}" method="post">@csrf
                            @if ($errors->any())
