...
@section('content')
    <section class="page-header">
        ...
        <!-- /.page-header__shape -->
        <div class="container">
            <h2 class="page-header__title bw-split-in-right">{{ $page->name }}</h2>
    ...
    <section class="about-four about-four-about" id="about">
        <div class="container">
            <div class="row gutter-y-30">
                <div class="col-xl-4 col-md-12">
                    <div class="about-four__img bw-img-anim-left">
                ...
                <div class="col-xl-5 col-lg-8 col-md-12">
                    <div class="about-four__content">
                        <div class="sec-title text-left">
                            ...
                            <h3 class="sec-title__title bw-split-in-up">{{ __('Güven, Tecrübe ve') }} <span>{{ __('Çözüm Odaklı Hukuk Hizmetler') }}</span></h3><!-- /.sec-title__title -->
                        </div><!-- /.sec-title -->
                        <p class="about-four__text">
                            {!! $page->description !!}
                        </p>
                        <ul class="list-unstyled about-four__list">
                            <li class="about-four__item">
                        ...
                        <div class="about-four__btns">
                            <a href="{{ route(getOtherFullLink('contact')) }}" class="procounsel-btn ">
                                <i> {{ __('İletişim') }}</i>
                                <span> {{ __('İletişim') }}</span>
                            </a>
                            <img src="/storage/{{ $settings->get('logo') }}" alt="Logo">
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-4 col-md-12">
                    <div class="about-four__right">
                        <div class="about-four__right__inner">
                            <div class="about-four__count count-box">
                                <h3 class="about-four__count__number">
                                    <span class="count-text" data-stop="20" data-speed="1500"></span>
                                </h3>
                                <p class="about-four__count__text">{{ __('Yıllık Tecrübe') }}</p>
                            </div>
                            <div class="about-four__count count-box">
                                <h3 class="about-four__count__number">
                                ...
                                <p class="about-four__count__text">{{ __('Başarıyla Sonuçlanan Dava') }}</p>
                            </div>
                            <div class="about-four__count count-box">
                                <h3 class="about-four__count__number">
                                    <span class="count-text" data-stop="38" data-speed="1500"></span>
                                </h3>

                                <p class="about-four__count__text">{{ __('Müvekkil Danışmanlığı') }}</p>
                            </div>
                            <div class="about-four__count count-box">
                                <h3 class="about-four__count__number">
                                    <span class="count-text" data-stop="90" data-speed="1500"></span>
                                </h3>
                                <p class="about-four__count__text">{{ __('Güvenilir Hukuk Hizmeti') }}</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="barnds-one barnds-one-about">
        <div class="container">
                            ...
                            "1200": {
                                ...
                                <div class="item">
                                    <div class="barnds-one__img">
                                        <img src="/storage/{{ $reference->image }}" alt="{{ $reference->name }}">
                                    </div>
                                </div>
                                @endforeach
                            </div><!-- /.thm-owl__slider -->
