<section class="testimonials-two" id="testimonial">
    <div class="testimonials-two__bg" style="background-image: url(/theme4/images/shapes/testimonials-2-shape.png);"></div>
    <div class="container">
        <div class="row">
            <div class="col-xl-4">
                <div class="sec-title text-left">
                    ...
                    <h3 class="sec-title__title bw-split-in-up">{{ __('Birlikte Yazdığımız') }}<br> <span>{{ __('Başarı Hikâyeleri') }}</span></h3><!-- /.sec-title__title -->
                </div><!-- /.sec-title -->
                <p class="testimonials-two__text">
                    {{ __('Bizim için en büyük başarı, müvekkillerimizin memnuniyetidir. İşte birlikte yol aldığımız bazı müvekkillerimizin görüşleri.') }}
                </p>
                <div class="testimonials-two__carousel-nav">
                    <a href="#" class="testimonials-two__prev"><span class="icon-arrow-left"></span></a>
                    <a href="#" class="testimonials-two__next"><span class="icon-arrow-right"></span></a>
                </div>
            </div>
            <div class="col-xl-8">
                <div class="testimonials-two__carousel procounsel-owl__carousel procounsel-owl__carousel--with-shadow procounsel-owl__carousel--custom-nav owl-carousel" data-owl-nav-prev=".testimonials-two__prev" data-owl-nav-next=".testimonials-two__next" data-owl-options='{
                        "items": 1,
                        "margin": 0,
                        "loop": true,
                        "smartSpeed": 700,
                    ...
                    @foreach($allComments as $indexComment)
                        <div class="item">
                        <div class="testimonials-card-two wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='000ms'>
                            <div class="testimonials-card-two__content">
                                <div class="testimonials-card-two__top">
                                    ...
                                    <p class="testimonials-card-two__designation">{{ $indexComment->job }} </p><!-- /.testimonials-card-two__designation -->
                                </div>
                                ...
                                <p class="testimonials-card-two__text">
                                    {{$indexComment->comment}}</p>
                            </div><!-- /.testimonials-card-two__content -->
                            <div class="testimonials-card-two__images">
                                <img src="/storage/{{ $indexComment->image }}" alt=" {{ $indexComment->name }}">
                                <img class="static-image" src="/theme4/images/resources/testimonials-2-3.png" alt="{{ __('Anasayfa Müşteri Yorumları 1. Görsel') }}">
                                <img class="static-image" src="/theme4/images/resources/testimonials-2-2.jpg" alt="{{ __('Anasayfa Müşteri Yorumları 2. Görsel') }}">
