<section class="contact-two">
    <div class="contact-two__bg static-bg-image" style="background-image: url(/theme4/images/backgrounds/contact-2-bg.jpg);" alt="{{__('Anasayfa İletişim Formu Arka Plan Görseli')}}"></div>
    <img src="/theme4/images/resources/contact-2-1.png" alt="{{__('Anasayfa İletişim Formu Görseli')}}" class="contact-two__img wow fadeInUp static-image" data-wow-delay="150ms">
    <div class="contact-two__bg__shape"></div>
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                    ...
                    <ul class="list-unstyled contact-two__info">
                        ...
                        <li class="contact-two__info__item">
                            <div class="contact-two__info__icon">
                                ...
                                <span class="contact-two__info__icon__zoom">
                                            <i class="icon-telephone-call-1"></i>
                                        </span>
                            </div>
            ...
            <div class="col-md-6 wow fadeInUp" data-wow-delay="200ms">
                <form class="contact-one__form contact-form-validated form-one" method="post" action="{{ route('site.contact.message') }}">@csrf
