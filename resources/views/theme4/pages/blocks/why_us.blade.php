<section class="logos-why-choose">
    <div class="logos-why-choose__bg jarallax static-bg-image" data-jarallax="" data-speed="0.3" data-imgposition="50% -100%" style="background-image: url(/theme4/images/backgrounds/logos-why-choose-bg.jpg);" alt="{{ __('Anasayfa Neden Biz Arka Plan Görseli') }}"></div>
    <!-- Logos part -->
    <div class="logos-why-choose__logos">
                    ...
                    <div class="row">
                        <div class="col-lg-2">
                            <div class="barnds-one__text">
                                <h3>{{ __('Bize Güvenen') }} <br> {{ __('Kurumlar ve Müvekkiller') }}</h3>
                            </div>
                        </div>
                        <div class="col-lg-10">
    ...
    <div class="logos-why-choose__benefits">
        <div class="logos-why-choose__benefits__bg static-image" style="background-image: url(/theme4/images/backgrounds/why-choose-2-bg.jpg);" alt="{{ __('Anasayfa Neden Biz Görseli') }}"></div>
        <div class="container">
            <div class="row">
                <div class="col-lg-10">
                        ...
                        <div class="sec-title__tagline bw-split-in-up-fast d-inline-flex align-items-center gap-2">
                            <div>
                                <svg class="hammer" width="23" height="23" viewbox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M21.6562 20.875H10.7188C10.5115 20.875 10.3128 20.9573 10.1663 21.1038C10.0198 21.2503 9.9375 21.449 9.9375 21.6562C9.9375 21.8635 10.0198 22.0622 10.1663 22.2087C10.3128 22.3552 10.5115 22.4375 10.7188 22.4375H21.6562C21.8635 22.4375 22.0622 22.3552 22.2087 22.2087C22.3552 22.0622 22.4375 21.8635 22.4375 21.6562C22.4375 21.449 22.3552 21.2503 22.2087 21.1038C22.0622 20.9573 21.8635 20.875 21.6562 20.875Z"></path>
                                    <path d="M13.8056 16.9688C13.1943 16.9695 12.6083 17.2126 12.1761 17.6448C11.7439 18.0771 11.5007 18.6631 11.5 19.2744V20.0938H20.875V19.2744C20.8743 18.6631 20.6311 18.0771 20.1989 17.6448C19.7667 17.2126 19.1807 16.9695 18.5694 16.9688H13.8056Z"></path>
                    ...
                    <div class="logos-why-choose__benefits__content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="logos-why-choose__benefits-box">
                                    <h2 class="logos-why-choose__benefits-box__count"></h2>
                                    <h4 class="logos-why-choose__benefits-box__title">{{ __('Şeffaf ve Güvenilir Yaklaşım') }}</h4>
                                    <p class="logos-why-choose__benefits-box__text">
                                        {{ __('Hukuki süreçleri açık, anlaşılır ve dürüst bir dille aktarıyoruz. Güvenin, güçlü bir savunmanın temeli olduğuna inanıyoruz.') }}
                                    </p>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="logos-why-choose__benefits-box">
                                    <h2 class="logos-why-choose__benefits-box__count"></h2>
                                    <h4 class="logos-why-choose__benefits-box__title">{{ __('Kişiye Özel Hukuki Strateji') }}</h4>
                                    <p class="logos-why-choose__benefits-box__text">
                                        {{ __('Her dava benzersizdir. Bu yüzden hazır kalıplarla değil, size özel hazırlanmış stratejilerle hareket ediyoruz.') }}
                                    </p>
                                </div>
                            </div>
                        </div><!-- /.row -->
