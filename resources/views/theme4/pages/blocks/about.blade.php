        ...
        <div class="row">
            <div class="col-xl-8">
                <div class="sec-title text-left">
                    ...
                    <h3 class="sec-title__title bw-split-in-up">{{ __('Güven, Tecrübe ve Çözüm Odaklı') }}<br><span>{{ __('Hukuk Hizmetler') }}</span></h3><!-- /.sec-title__title -->
                </div><!-- /.sec-title -->
                <p class="about-three__text">
                    {{ __('Her davada kapsamlı analiz ve etkili stratejilerle en uygun hukuki çözümleri üretiyoruz.') }}
                </p>
                <div class="about-three__left">
                    <div class="about-three__left__img bw-img-anim-left">
                        <img class="static-image" src="/theme4/images/resources/about-2-1.jpg" alt="{{ __('Anasayfa Hakkımızda 1.Görsel') }}">
                    </div>
                    <div class="about-three__left__content wow fadeInUp" data-wow-delay="200ms">
                        <div class="about-three__left__bottom">
                            <h3 class="about-three__left__bottom-title">{{ __('Hukukta Uzmanlık, Çözümde Güven.') }}</h3>
                            <ul class="list-unstyled about-three__left__bottom-list">
                                <li class="about-three__left__bottom-item">
                                    <i class="icon-check"></i>
                                    {{ __('Evrak ve Süreç Yönetimi') }}: {{ __('Davalara ve resmi işlere ait tüm belgeleriniz titizlikle hazırlanır ve takip edilir.') }}
                                </li>
                                <li class="about-three__left__bottom-item">
                                    <i class="icon-check"></i>
                                    {{ __('Güvenilir Hukuki Ağ') }}: {{ __('Baro, kurum ve uzmanlarla güçlü bağlantılar sayesinde müvekkillerimize daha geniş bir destek sunarız.')}}
                                </li>
                                <li class="about-three__left__bottom-item">
                                    <i class="icon-check"></i>
                                   {{ __('Kişiye Özel Stratejiler')}}: {{ __('Her müvekkilin ihtiyacına göre özgün hukuki yol haritaları belirler, en doğru çözüme ulaştırırız.') }}
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="col-xl-4">
                <div class="about-three__right">
                    <div class="about-three__right-img">
                        <img class="bw-img-anim-left static-image" src="/theme4/images/resources/about-2-2.jpg" alt="{{ __('Ansayfa Hakkımızda 2. Görsel') }}">
                        <div class="about-three__right-shape">
                            <img class="static-image" src="/theme4/images/shapes/about-2-shape-1.png" alt=" {{ __('Ansayfa Hakkımızda 3. Görsel') }}">
                        </div>
                    </div>
                    <div class="about-three__right-icon">
