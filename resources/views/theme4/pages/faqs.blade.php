...
@section('content')
    <section class="page-header">
        ...
        <div class="container">
            ...
            <ul class="procounsel-breadcrumb list-unstyled">
                ...
                <li>
                    <span>{{ __('Sıkça Sorulan Sorular') }}</span>
                </li>
            </ul>
        </div>
    </section>
    ...
    <div class="faq-top">
        <div class="container">
            <div class="faq-top__wrapper">
                <h2 class="faq-top__title">
                    {{ __('Hukuki Sorularınız mı Var? Bize Ulaşın!') }}
                </h2>
                <ul class="faq-top__list">
                    <li>
                        <i class="icon-mail"></i>
                        <a href="mailto:{{ $settings->get('email') }}m">
                            {{ $settings->get('email') }}
                        </a>
                    </li>
                    <li>
            ...
            <div class="row">
                    ...
                    <div class="faq-one__content">
                        <div class="sec-title text-left">
                            ...
                            <h3 class="sec-title__title bw-split-in-up">
                                {{ __('Hukuki Sorularınız mı Var?') }} <br />
                                <span>{{ __('Bize Ulaşın!') }}</span>
                            </h3>
                        </div>

                        <div class="faq-one__accordion procounsel-accrodion" data-grp-name="procounsel-accrodion">
                            @if(!empty($faqCategories) && count($faqCategories) > 0) @foreach($faqCategories as $faqCategory)
                                <div class="faq-category mb-4">
                                    <h4 class="faq-category__title mb-3">{{ $faqCategory->name }}</h4>

                                    <div class="faq-one__accordion procounsel-accrodion" data-grp-name="procounsel-{{ \Illuminate\Support\Str::slug($faqCategory->name) }}">
                                        ...
                                        >
                                            {{ $faq->id }}
                                                    ...
                                                    <h4>
                                                        {{ $faq->question }}
                                                        <i class="accrodion-title__icon"></i>
                                                    </h4>
                                                </div>
                                                <div class="accrodion-content">
                                                    <div class="inner">{{ $faq->answer}}</div>
                                                </div>
                                            </div>
                                        @endforeach
                                    </div>
                            ...
                            @endforeach @else
                                ...
                                <div class="accrodion">
                                    <div class="accrodion-title">
                                        ...
                                        <h4>{{ $faq->question }} <i class="accrodion-title__icon"></i></h4>
                                    </div>
                                    <div class="accrodion-content">
                                        <div class="inner">{!! $faq->answer !!}</div>
                                    </div>
                ...
                <div class="col-lg-6">
                    <div class="faq-one__img">
                        <img src="/theme4/images/resources/faq-1-1.jpg" alt="{{ __('Sıkça Sorulan Sorular Sayfası 1.Görsel') }}" class="faq-one__img__one static-image" />
                        <img src="/theme4/images/resources/faq-1-2.jpg" alt="{{ __('Sıkça Sorulan Sorular Sayfası 2.Görsel') }}" class="faq-one__img__two static-image" />
                        <img src="/theme4/images/resources/faq-1-3.png" alt="{{ __('Sıkça Sorulan Sorular Sayfası 3.Görsel') }}" class="faq-one__img__three static-image" />
                        <div class="faq-one__img__shape"></div>
                    </div>
                </div>
            </div>
        </div>
