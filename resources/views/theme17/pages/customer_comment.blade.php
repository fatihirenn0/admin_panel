...
@section('content')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="inner-banner-content">
                        <h1 class="h1-title">{{ __('Müşteri Yorumları') }}</h1>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="main-testimonials">
        <span class="testimonial-bg-shape"> <img class="static-bg-image" src="/theme17/images/testimonial-bg-shape.svg" width="405" height="641" alt="{{ __('Müşteri Yorumlar Sayfası Arka Plan Görseli') }}" /></span>
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial-box">
                                        <div class="testimonial-box-shape">
                                            <img class="static-image" src="/theme17/images/testimonial-box-shape.svg" width="170" height="55" alt="{{ __('Müşteri Yorumlar Sayfası Görsel') }}" />
                                        </div>
                                        ...
                                        <div class="testimonial-img back-img" style="background-image: url('/storage/{{ $customerComment->image }}')"></div>
                                        <div class="review-by">
                                            <h4 class="h4-title">{{ $customerComment->name }}</h4>
                                            <p>{{ $customerComment->job }}</p>
                                        </div>
